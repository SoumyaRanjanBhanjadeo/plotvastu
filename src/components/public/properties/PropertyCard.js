...
export function PropertyCard({ property }) {
  ...
  return (
    <motion.div
      ...
      className="group bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100 hover:shadow-2xl transition-all"
    >
      {/* Image */}
      ...
      <div className="p-5">
        ...
        <div className="flex items-center gap-4 text-sm text-gray-600 mb-4">
          ...
          {property.views > 0 && (
            <span className="text-gray-400">{property.views} views</span>
          )}
        </div>
